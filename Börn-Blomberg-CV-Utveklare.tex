...
Björn är en passionerad utvecklare med strax över två års erfarenhet av fullstack-
...
också andra tekniker och verktyg som JavaScript, Bootstrap, React.js, MongoDB,
 Elastic Search, Googel-cloud och Git, vilket gör honom anpassningsbar och 
 kapabel att jobba med de flesta teknologier. Ända sedan chatt-GPT kom ut har 
 björn jobbat med tjänsten och liknande tjänster. 
